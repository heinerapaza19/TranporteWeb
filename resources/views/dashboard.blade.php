            ...
            <div class="card card-outline elevation-3 bg-white text-dark border-0">
                <div class="card-header border-0 bg-white">
                    <h3 class="card-title text-dark">
                        <i class="fas fa-map-marked-alt"></i> Empresas de Transporte - Según la empresa
                    </h3>
                </div>

                <div class="card-body" style="background-color: #ffffff !important; border-radius: 10px;">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="card shadow-sm border-0 h-100"
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <p class="mb-2 small opacity-75">Cobertura: Zona Norte</p>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="card shadow-sm border-0 h-100"
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <p class="mb-2 small opacity-75">Cobertura: Zona Este</p>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="card shadow-sm border-0 h-100"
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <p class="mb-2 small opacity-75">Cobertura: Zona Centro</p>

                                    <a href="{{ url('/mapa/22') }}"
                                        class="btn btn-info btn-sm px-4 rounded-pill text-white fw-bold">
                                        <i class="fas fa-map-marked-alt"></i> Ver mapa
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="card shadow-sm border-0 h-100"
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <p class="mb-2 small opacity-75">Cobertura: Zona Sur</p>
            ...
            <div class="col-lg-3 col-md-6 col-12 mb-4">
                <div class="card card-widget widget-user elevation-4">
                    ...
                    <div class="card-footer text-center" style="padding-top: 20px;">
                        ...
                        <a href="#" class="btn btn-info btn-sm px-4 rounded-pill"><i
                ...
                <div class="row text-white">
                    ...
                    <div class="col-md-3 mb-4">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><a href="#" class="text-light text-decoration-none fs-5">Tarjetas de recarga</a>
                            </li>
                        </ul>
                    </div>
