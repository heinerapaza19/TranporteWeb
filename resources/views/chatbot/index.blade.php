...
<div class="d-flex justify-content-between align-items-center">
    <h1 class="text-warning mb-0">
        <i class="fas fa-robot"></i> Asistente Virtual del Transporte
    </h1>
    <button id="closeAssistant" class="btn btn-sm btn-outline-warning fw-bold"
        style="border-radius: 50%; width: 36px; height: 36px; font-size: 16px; line-height: 1;">✕</button>
</div>
@stop
...
.category-card .card-desc {
    ...
    <p style="margin:5px 0 0 0; opacity:0.9; font-size:14px;">¿En qué puedo ayudarte hoy?</p>
            ...
            <div id="chatWindow" class="chat-window">
               <div class="chat-header" style="position: relative; background: #E67E22; color: white;">
    <!-- Flecha de retroceso -->
    <button onclick="backToWelcome()" 
        style="position: absolute; left: 20px; background: none; border: none; color: white; font-size: 20px; cursor: pointer;">
        <i class="fas fa-arrow-left"></i>
    </button>

    <h2 style="margin: 0; text-align:center;">Transporte Bot</h2>
    <p style="margin: 5px 0 0 0; opacity: 0.9; font-size: 14px; text-align:center;">En línea</p>

    <!-- 🔴 Botón “Z” visible arriba a la derecha -->
    <button onclick="cerrarChat()" 
    style="position: fixed; right: 25px; top: 120px; background: #e74c3c; border: none; color: white;
           font-size: 18px; border-radius: 50%; width: 35px; height: 35px; cursor: pointer;">
    ✖
</button>
                ...
                <div class="chat-input-area">
                    <form id="chatForm" onsubmit="sendMessage(event)">
                        <div class="chat-input-wrapper">
                            <input type="text" id="chatInput" class="chat-input" placeholder="Pregunta lo que quieras..."
